...
import useVerEstudiante from 'src/modules/estudiantes/composables/useVerEstudiante';
...
import useCrearEntregaRes from '../composables/useCrearEntregaRes';
import {
...
const { createEntrega, isLoadingCreate, errorServer } = useCrearEntregaRes(
  id + ''
);
...
const links: Breadcrumb[] = [
  { label: 'Residentes', icon: 'school', to: 'listar-residente' },
